@extends('layouts.auth', ['title' => 'Register - Quiz App'])
    ...
    <div class="row w-100" style="height: 100svh;">
        <div class="col col-12 col-md-6 col-lg-7 d-flex flex-column justify-content-center" id="hero">
            ...
            <div class="d-flex justify-content-center">
                <img src="{{ url('assets/images/hero-register.gif') }}" alt="Register" style="width: 80%; height: auto;">
            </div>
        </div>
